    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          className="relative border-0 transition-all duration-150"
          data-testid="header-notifications"
        >
          <Bell className="h-4 w-4 transition-colors duration-150" />
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 h-4 min-w-[1rem] px-1 rounded-full bg-red-600 dark:bg-red-500 text-white text-[10px] flex items-center justify-center">
