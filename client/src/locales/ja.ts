export const ja = {
  ...
  auth: {
    ...
    signup: {
      ...
      checkEmailNotice: "確認メールを送信しました。メールのリンクをクリックしてアカウントを有効化してください。",
    },
    verify: {
      title: "メールアドレスを確認",
      subtitle: "{{email}} に6桁の確認コードを送信しました",
      codeDigit: "確認コード {{index}}桁目",
      codeHint: "メールに記載されている6桁のコードを入力してください",
      codeIncomplete: "6桁の確認コードを入力してください",
      verify: "確認する",
      verifying: "確認しています...",
      noCode: "コードが届きませんか?",
      resend: "再送信する",
      resendCooldown: "再送信可能まで {{seconds}}秒",
      resendError: "コードの再送信に失敗しました。しばらくしてからもう一度お試しください。",
      error: "確認コードが正しくありません。もう一度お試しください。",
      success: "メールアドレスが確認されました!",
      backToLogin: "ログインに戻る",
      sending: "確認コードを送信しています...",
      pleaseWait: "しばらくお待ちください",
      sendError: "確認コードの送信に失敗しました。もう一度お試しください。",
    },
    signupEmail: {
      title: "メールアドレスを入力",
      subtitle: "ワークスペースへのログインに使用するメールアドレスを入力してください",
      emailLabel: "メールアドレス",
      emailPlaceholder: "name@company.com",
      emailHint: "職場または学校のメールアドレスを使用することをおすすめします",
      continue: "次へ",
      or: "または",
      haveAccount: "すでにアカウントをお持ちですか?",
      signIn: "サインイン",
      checkingEmail: "メールアドレスを確認しています...",
      error: "メールアドレスの確認に失敗しました。もう一度お試しください。",
    },
    signupComplete: {
      title: "プロフィールを完成させましょう",
      subtitle: "最後のステップです!",
      emailVerified: "メールアドレスが確認されました: {{email}}",
      nameLabel: "氏名",
      namePlaceholder: "山田 太郎",
      nameHint: "本名またはニックネームを入力してください",
      passwordLabel: "パスワード",
      passwordPlaceholder: "8文字以上のパスワード",
      passwordHint: "安全性の高いパスワードを設定してください",
    ...
    workspaceSelect: {
      ...
      subtitle: "ワークスペースを作成するか、既存のワークスペースに参加してください",
      createNew: "新しいワークスペースを作成",
      createDescription: "チームのための新しいワークスペースを立ち上げます",
      joinExisting: "既存のワークスペースに参加",
      joinDescription: "招待コードを使ってワークスペースに参加します",
      hint: "後でいつでもワークスペースを切り替えたり追加したりできます",
    },
    workspaceCreate: {
      title: "ワークスペースを作成",
    ...
    workspaceJoin: {
      ...
      inviteCodeHelp: "ワークスペース管理者から共有された招待コードを入力してください",
      emailLabel: "メールアドレス",
      ...
      inviteValid: "有効な招待コードです",
      joining: "参加しています...",
      or: "または",
      noInvite: "招待コードをお持ちでないですか?",
      createNew: "新しいワークスペースを作成",
      invalidInvite: "無効な招待コードです",
      enterInviteCode: "招待コードを入力してください",
      error: "ワークスペースへの参加に失敗しました。もう一度お試しください。",
    },
  },
  dashboard: {
    log: {
  ...
  landing: {
    ...
    hero: {
      title: "チームのコラボレーションを、もっとシンプルに",
      subtitle: "チャット、タスク、ナレッジ、ミーティングを1つのプラットフォームで。BizLinkOneでチームの生産性を最大化しましょう。",
      cta: "無料で始める",
      secondaryCta: "ログイン",
      features: {
        free: "永久無料プラン",
    ...
    features: {
      title: "必要な機能がすべて揃っています",
      subtitle: "チームのコラボレーションに必要なツールを、1つのプラットフォームで提供します",
      chat: {
        title: "リアルタイムチャット",
        description: "チャンネルやダイレクトメッセージでスムーズにコミュニケーション。ファイル共有や絵文字も完備。",
      },
      tasks: {
        title: "タスク管理",
        description: "カンバンボードやガントチャートで進捗を可視化。優先度と期限で効率的に管理。",
      },
      knowledge: {
        title: "ナレッジベース",
        description: "チームの知見を蓄積・共有。タグやカテゴリーで検索しやすく整理。",
      },
      meetings: {
        title: "ミーティング管理",
        description: "予定の調整からメモの共有まで。録画機能でいつでも振り返り可能。",
      },
    },
    benefits: {
      title: "なぜBizLinkOneなのか",
      subtitle: "チームのパフォーマンスを向上させる理由",
      productivity: {
        title: "生産性向上",
        description: "複数のツールを行き来する必要なし。すべてが1ヶ所に。",
      },
      collaboration: {
        title: "シームレスな共同作業",
        description: "リアルタイムで情報共有。チーム全体が同じページに。",
      },
      security: {
        title: "エンタープライズレベルのセキュリティ",
        description: "データ暗号化、2要素認証、アクセス権限管理で安心。",
      },
      anywhere: {
        title: "どこからでもアクセス",
        description: "クラウドベースだから、オフィスでも在宅でも外出先でも。",
      },
    },
    pricing: {
      title: "シンプルでわかりやすい料金プラン",
      subtitle: "チームの規模に合わせて最適なプランを選択できます",
      popular: "人気",
      free: {
        name: "無料プラン",
        price: "¥0",
    ...
    cta: {
      title: "今すぐチームのコラボレーションを変革しましょう",
      subtitle: "無料プランで今日から始められます。クレジットカードは不要です。",
      button: "無料で始める",
    },
    footer: {
